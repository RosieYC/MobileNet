...
def test_net(save_folder, net, cuda, testset, transform, thresh):
    ...
    for i in range(num_images):
        ...
        pred_num = 0
        img = cv2.imread(r'/data/pro_SSD_pytorch/ssd.pytorch-master/data/VOCdevkit/VOC2007/JPEGImages/'+img_id+'.jpg')
        for i in range(detections.size(1)):
            ...
            while detections[0, i, j, 0] >= 0.4:
                ...
                #cv2.imwrite(r'/data/pro_SSD_pytorch/ssd.pytorch-master/data/VOCdevkit/VOC2007/result_img/'+img_id+'.jpg', img)
                pred_num += 1
                with open(filename, mode='a') as f:
...
def test_voc():
    ...
    net = create_mobilenetv2_ssd_lite('test', 300, num_classes) # initialize SSD
